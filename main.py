...
def elso_harom(honapok_szama, szemelyek_szama):
    ...
    print(f'1. {sorrend[0][1]}  {(sorrend[0][0] / szemelyek_szama * 100):.1f}%')
    print(f'2. {sorrend[1][1]}  {(sorrend[1][0] / szemelyek_szama * 100):.1f}%')
    print(f'3. {sorrend[2][1]}  {(sorrend[2][0] / szemelyek_szama * 100):.1f}%')
